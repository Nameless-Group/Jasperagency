<section class="contact-page-area py-130 rpy-100 rel z-1">
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-lg-6">
                <div class="our-location-part rmb-55 wow fadeInUp delay-0-2s animated" style="visibility: visible; animation-name: fadeInUp;">
                    <div class="row">
                        <div class="col-xl-10">
                    ...
                    <div class="row gap-80 pb-30">
                        <div class="col-sm-6">
                            <div class="our-location-address mb-40">
                                ...
                                <a class="callto" href="callto:+905415750103"><i class="fas fa-phone"></i> +90 (541) 575 0103</a>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="our-location-address mb-40">
                                <h5>Myanmar (Burma)</h5>
                                <a class="mailto" href="mailto:support@gmail.com">support@gmail.com</a><br>
                                <a class="callto" href="callto:+9599573979973"><i class="fas fa-phone"></i> +95 (995) 7397 9973</a>
                            </div>
                        </div>
                    </div>
                    <h4>Follow Us</h4>
            ...
            <div class="col-xl-5 col-lg-6">
                <div class="contact-page-form form-style-one wow fadeInUp delay-0-2s animated" style="visibility: visible; animation-name: fadeInUp;">
                    <div class="section-title mb-35">
                        <span class="sub-title mb-15">Get Free Quote</span>
                        <h3>Drop Us a Message</h3>
                    </div>
                    <form id="contactForm" class="contactForm" action="/home/contact-us" name="contactForm" method="post" novalidate="true">
                        @csrf
                        <div class="row gap-60 pt-15">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="name"><i class="far fa-user"></i></label>
                                    <input type="text" id="fullname" name="fullname" class="form-control" value="" placeholder="Full Name" required="" data-error="Please enter your name">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="radio" name="type" value="other"> Something else<br>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group pt-5 mb-0">
                                    <button type="submit" class="theme-btn style-two w-100 disabled" style="pointer-events: all; cursor: pointer;">Send Message us <i class="far fa-arrow-right"></i></button>
